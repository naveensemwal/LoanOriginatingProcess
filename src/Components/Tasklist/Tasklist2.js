...
export default class Tasklist extends Component {
    ...
    getData = () => {
        ...
        Axios.get(`/rest/bpm/wle/v1/tasks?savedSearch=My_Task_List&interaction=claimed_and_available&searchFilter=Underwriter&filterByCurrentUser=false&calcStats=false`, {
            auth: {
                username: 'p8admin',
